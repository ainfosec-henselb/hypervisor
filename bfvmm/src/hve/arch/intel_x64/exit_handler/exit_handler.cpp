...
{
    //bfdebug_nhex(0, "wrmsr", msr);
    // bferror_subnhex(0, "offset", msr);
    // bferror_subnhex(0, "val", val);
    switch (msr) {
        case ::intel_x64::msrs::ia32_debugctl::addr:
...
static bool
handle_xsetbv(gsl::not_null<bfvmm::intel_x64::vmcs *> vmcs)
{
    bferror_info(0, "xsetbv");
    halt(vmcs);
    return advance(vmcs);
}
    ...
    m_stack{std::make_unique<gsl::byte[]>(STACK_SIZE * 2)}
{
    ...
    // add_handler(
    //     exit_reason::basic_exit_reason::xsetbv,
    //     handler_delegate_t::create<handle_xsetbv>()
    // );
}
...
{
    //bferror_info(0, ::intel_x64::vmcs::exit_reason::basic_exit_reason::description());
    //bferror_subtext(
    //            0, "exit_reason",
...
// x64::idt* exit_handler::host_idt()
// {
//     return &m_host_idt;
// }

// x64::tss* exit_handler::host_tss()
// {
//     return &m_host_tss;
// }
